...
const [isAnyItemSelected, setIsAnyItemSelected] = useState(false);
    ...
    //     // Select the first item on long press
    //     setSelectedTrips((prevSelected) => ({
    //       ...prevSelected,
    //       [tripId]: true,
    //     }));
    //     setIsAnyItemSelected(true); // Mark that an item has been selected
    //   }
    // };

    // const handlePress = (tripId) => {
    //   if (isAnyItemSelected) {
    //     // Toggle selection for subsequent items with a single press
    //     setSelectedTrips((prevSelected) => ({
    //       ...prevSelected,
    //       [tripId]: !prevSelected[tripId],
    //     }));
    //   }
    // };
      ...
      if (isHeaderVisible) {
        return (
          <View style={styles.headerContainer}>
            ...
            <Image style={styles.leftArrow} source={require('../assets/leftArrow.webp')} />
            </TouchableOpacity>
            <Text style={styles.selectedCountText}>{selectedCount}</Text>
           
            <View style={styles.headerIconsContainer}>
              <TouchableOpacity onPress={handleAddPress}>
              <Image style={styles.icon} source={require('../assets/plusIcon.webp')} />
              </TouchableOpacity>
              <TouchableOpacity onPress={handleDeletePress}>
              <Image style={styles.icon} source={require('../assets/deleteIcon.webp')} />
              </TouchableOpacity>
            </View>
          </View>
        );
      }
      return null; // Return null if header is not visible
    };
              ...
              <View key={trip.id}>
                ...
                <View style={styles.tripCard}>
                  ...
                  <Image
                      ...
                      source={require('../assets/settingsIcon.webp')}
                    />
                  </TouchableOpacity>
        ...
        <View style={{ margin: dimensions.paddingLevel3 }}>
          ...
          <View style={styles.optionRow}>
            ...
            <TouchableOpacity onPress={() => openModal('Group By')} style={styles.optionBox}>
              ...
              <Image style={styles.downArrow} source={require('../assets/downArrow.webp')} />
            </TouchableOpacity>
          </View>
          <View style={styles.lineHorizontal} />
          <View style={styles.optionRow}>
...
const styles = StyleSheet.create({
  ...
  selectedCard: {
  //  backgroundColor: '#E0F7FA', // light blue or any color for selected background
   // borderColor: '#00796B', // a border to highlight the selection
  //  borderWidth: 2,
  },
  checkIcon: {
    position: 'absolute',
