  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.white }}>
      ...
      <ScrollView>
        ...
        <DialogBoxComponent visible={dialogVisible.settings} content="Settings Content" />
        <View style={styles.line2wrapper}>
          <View style={styles.line2} />
        </View>

        {renderTopic('trackOrders', 'Track Orders')}
        <DialogBoxComponent visible={dialogVisible.trackOrders} content="Track Orders Content" />
        <View style={styles.line2wrapper}>
          <View style={styles.line2} />
        </View>

        {renderTopic('viewEarnings', 'View Earnings')}
        <DialogBoxComponent visible={dialogVisible.viewEarnings} content="View Earnings Content" />
        ...
        <DialogBoxComponent visible={dialogVisible.signup} content="Signup Content" />
        <View style={styles.line2wrapper}>
          <View style={styles.line2} />
        </View>

        {renderTopic('signIn', 'Sign-in')}
        <DialogBoxComponent visible={dialogVisible.signIn} content="Sign-in Content" />
        <View style={styles.line2wrapper}>
          <View style={styles.line2} />
        </View>

        {renderTopic('customerSearch', 'Customer: Search')}
        <DialogBoxComponent visible={dialogVisible.customerSearch} content="Customer: Search Content" />
        <View style={styles.line2wrapper}>
          <View style={styles.line2} />
        </View>
        ...
        <View style={styles.collapsibleHeader}>
          ...
          <DialogBoxComponent visible={dialogVisible.driverSearch} content="Driver Search Content" />
        </View>
        ...
        {isExpanded && (
          ...
          <View style={styles.line2wrapper}>
            ...
            <DialogBoxComponent visible={dialogVisible.problemSigningIn} content="Problem Signing in Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('order', 'Order')}
            <DialogBoxComponent visible={dialogVisible.order} content="Order Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('trackOrder', 'Track Order')}
            <DialogBoxComponent visible={dialogVisible.trackOrder} content="Track Order Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('deliveryIssue', 'Delivery issue')}
            <DialogBoxComponent visible={dialogVisible.deliveryIssue} content="Delivery issue Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('rideIssue', 'Ride issue')}
            <DialogBoxComponent visible={dialogVisible.rideIssue} content="Ride issue Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('roadSupport', 'Road Support')}
            <DialogBoxComponent visible={dialogVisible.roadSupport} content="Road Support Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>
            ...
            <DialogBoxComponent visible={dialogVisible.payment} content="Payment Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('missingPayment', 'Missing Payment')}
            <DialogBoxComponent visible={dialogVisible.missingPayment} content="Missing Payment Content" />
            <View style={styles.line2wrapper}>
              <View style={styles.line2} />
            </View>

            {renderTopic('review', 'Review')}
            <DialogBoxComponent visible={dialogVisible.review} content="Review Content" />
          </>
        )}
        ...
        <View style={styles.lineContainer}>
          ...
          <TouchableOpacity onPress={toggleExpand} style={styles.arrowButton}>
            <Image
              source={isExpanded ? require('../assets/upArrow.webp') : require('../assets/downArrow.webp')}
              style={styles.icon3}
            />
          </TouchableOpacity>
        </View>
        ...
        <View>
          ...
          <TouchableOpacity style={styles.rowContainer} onPress={handlePickupTask}>
            <Text style={[{ color: colors.black }, styles.title]}>View Active Messages</Text>
        ...
        <View>
          ...
          <TouchableOpacity style={styles.rowContainer} onPress={handleLiveChat}>
          ...
          <TouchableOpacity style={styles.rowContainer} onPress={handleAddOnService}>
